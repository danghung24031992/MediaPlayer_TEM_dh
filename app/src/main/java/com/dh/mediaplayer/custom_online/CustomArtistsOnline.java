 ...
 */
public class CustomArtistsOnline extends BaseAdapter {
    private Activity context;
    private LayoutInflater inflater;
    private ArrayList<SingerBean> listItem;


    public CustomArtistsOnline(Activity context, ArrayList<SingerBean> listItem) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            Bitmap bitmap = new LoadImageFromURL().execute(singer.getThumbImage()).get();
            if (bitmap != null){
