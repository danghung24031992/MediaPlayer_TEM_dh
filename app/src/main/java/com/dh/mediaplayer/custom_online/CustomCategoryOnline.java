 ...
 */
public class CustomCategoryOnline extends BaseAdapter {
    ...
    public CustomCategoryOnline(Activity context, ArrayList<CategoryBean> listItem) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CategoryBean categoryBean = listItem.get(position);
        try {
            Bitmap bitmap = new LoadImageFromURL().execute(categoryBean.getThumbImage()).get();
            if (bitmap != null){
...
//        holder.imgArtists.setImageResource(Integer.parseInt(singer.getThumbImage()));
        holder.tvArtistsName.setText(categoryBean.getCategoriesName());
